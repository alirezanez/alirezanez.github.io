...
My photography collection capturing landscapes, historical sites, and nature across the world.

---

## Landscapes

Beautiful natural scenery from my travels around the world.
...
Photography documenting significant historical and cultural sites.

<div class="row">
    <div class="col-sm-6 col-md-4 mb-4">
        <div class="card h-100">
            <img src="{{ site.baseurl }}/assets/img/photography/persepolis-iran.jpg" class="card-img-top" alt="Persepolis, Iran">
            <div class="card-body">
                <h5 class="card-title">Persepolis, Iran</h5>
                <p class="card-text">Ancient gates and lamassu sculptures of Persepolis, one of the most significant historical sites of the Achaemenid Empire.</p>
            </div>
        </div>
    </div>
    <div class="col-sm-6 col-md-4 mb-4">
...
Close-up photography of flowers and botanical subjects.
