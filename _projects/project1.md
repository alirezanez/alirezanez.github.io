...
**Publication:**
- [Fault Detection and Fault-Tolerant Control of Permanent Magnet Linear Motors Using an Emotional Learning-Based Neural Network and a Linear Extended State Observer - Murdoch University](https://researchportal.murdoch.edu.au/esploro/outputs/journalArticle/Fault-Detection-and-Fault-Tolerant-Control-of/991005876850307891)

<img src="{{ site.baseurl }}/assets/img/projects/pmlm_fault_detection.png" alt="PMLM Fault Detection Project" style="max-width: 500px; height: auto;">